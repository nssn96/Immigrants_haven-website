...
<table class="w3-table-all" style="width:70%;margin-left:20%">
     ...
     <tr class="w3-grey">
          ...
          @csrf
            ...
            @foreach($dataall['countries'] as $country)
                    ...
                    <tr>
                      ...
                      <td><input type="submit" name="delete" class="w3-btn w3-white w3-border w3-round-large" value="Delete" id="delete"></td>
                          <td><a href="managecountry/{{$country->country_id}}">Update</a></td>
                          <td><label class="container">
                            <input type="checkbox" name="checkbox[]" type="checkbox" id="checkbox[]" value= {{$country->country_id}}>
