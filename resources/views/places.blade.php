...
<body>
    ...
    <div class="main">
        <div class="clearfix">
            <div class="main1">
                <h2 class="heading" style="color: rgb(32,85,138);">Welcome to Places Page</h2>
                <p class="para">Here you can find details of Places</p>
                <div class="browse">
                    <input type="text" name="place" class="museum" placeholder="Enter the Place Name">
