...
<body>
    ...
    <form action="searchmuseum" method="POST">
    @csrf
    <div class="main">
        <div class="clearfix">
            <div class="main1">
                <h2 class="heading" style="color: rgb(32,85,138);">Welcome to Museums Page</h2>
                <p class="para">Here you can find details of Museums</p>
                <div class="browse">
                    <input type="text" name="museum" class="museum" placeholder="Enter the Museum Name">
