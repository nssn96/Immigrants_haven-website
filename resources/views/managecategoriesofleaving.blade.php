...
<thead>
        ...
        @foreach($dataall['categories'] as $category)
                    <tr>
                    <td>{{$category->category_id}}</td>
                        ...
                        <td><input type="submit" name="delete" class="w3-btn w3-white w3-border w3-round-large" value="Delete" id="delete"></td>
                          <td><a href="managecategoriesofleaving/{{$category->category_id}}">Update</a></td>
                          <td><label class="container">
                            <input type="checkbox" name="checkbox[]" type="checkbox" id="checkbox[]" value= {{$category->category_id}}>
