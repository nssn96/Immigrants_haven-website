...
<body >
    ...
    <div>
            ...
            <?php $__currentLoopData = $dataall['continents']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $continent): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  <tr>
                       
                          <td><?php echo e($continent->continent_id); ?></td>
                          <td><?php echo e($continent->continent_name); ?></td>
                          <form action="manage" method="GET">
                          <?php echo csrf_field(); ?>
                          <td><input type="submit" name="delete" class="w3-btn w3-white w3-border w3-round-large" value="Delete" id="delete"></td>
                          <td><a href="managecontinent/<?php echo e($continent->continent_id); ?>">Update</a></td>
                          <td><label class="container">
                            <input type="checkbox" name="checkbox[]" type="checkbox" id="checkbox[]" value= <?php echo e($continent->continent_id); ?>>
...
</html><?php /**PATH C:\xampp\xampp\htdocs\laravel\Immigrants_haeven\resources\views/managecontinentshtml.blade.php ENDPATH**/ ?>