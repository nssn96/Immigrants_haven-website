...
<table class="w3-table-all" style="width:70%;margin-left:20%">
     <thead>
          ...
          <?php $__currentLoopData = $dataall['placestovisit']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $placestovisits): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        <td><?php echo e($placestovisits->place_id); ?></td>
                       <td><?php echo e($placestovisits->place_name); ?></td>
                        <td><?php echo e($placestovisits->place_address); ?></td>
                        <td><?php echo e($placestovisits->city); ?></td>
                        <td><?php echo e($placestovisits->country); ?></td>
                        <td><?php echo e($placestovisits->contact_no); ?></td>
                        <td><?php echo e($placestovisits->category); ?></td>
                        ...
                        <td><input type="submit" name="delete" class="w3-btn w3-white w3-border w3-round-large" value="Delete" id="delete"></td>
                          <td><a href="updateplacesform/<?php echo e($placestovisits->place_id); ?>">Update</a></td>
                          <td><label class="container">
                            <input type="checkbox" name="checkbox[]" type="checkbox" id="checkbox[]" value= <?php echo e($placestovisits->place_id); ?>>
...
</html><?php /**PATH C:\xampp\xampp\htdocs\laravel\Immigrants_haeven\resources\views/manageplacestovisithtml.blade.php ENDPATH**/ ?>