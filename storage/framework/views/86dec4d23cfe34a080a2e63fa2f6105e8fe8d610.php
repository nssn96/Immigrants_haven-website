...
<div class="sidenav">
   ...
   <?php $contributions=$dataall['contributions'];?>
    <form method="GET" action="/editcontribution/<?php echo $contributions->contribution_id?>" method="POST">
    <?php echo csrf_field(); ?>
    <input type="text" name="name" id="contributionname" value="<?php echo $contributions->contribution_name?>" placeholder="Contribution Category" style="margin-left:40%;margin-top:3%">
    <input type="text" name="category" id="category" value="<?php echo $contributions->contribution_category?>" placeholder="Contribution Name" style="margin-left:40%;margin-top:3%">
    <input type="text" name="desc" id="desc" value="<?php echo $contributions->contribution_description?>" placeholder="Enter Contribution Description" style="margin-left:40%;margin-top:3%">
...
</html><?php /**PATH C:\xampp\xampp\htdocs\laravel\Immigrants_haeven\resources\views/contributionupdate.blade.php ENDPATH**/ ?>