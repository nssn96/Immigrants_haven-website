...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(URL::asset('css/visitorpagesstyle.css')); ?>">
...
<?php echo csrf_field(); ?>
        ...
        <?php $__currentLoopData = $dataall['fetch']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <div class="card-container"> 
         <div class="card">
        <img src="<?php echo e(asset($image->image_path)); ?>" style='width:100%'>
        <div class="container">
          <h4>Posted By:<?php echo e($image->username); ?></h4> 
...
</html><?php /**PATH C:\xampp\xampp\htdocs\laravel\Immigrants_haeven\resources\views/uploadimageshtml.blade.php ENDPATH**/ ?>