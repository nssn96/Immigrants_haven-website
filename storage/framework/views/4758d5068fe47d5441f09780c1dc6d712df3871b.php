...
<body>
    ...
    <div class="main">
        <div class="clearfix">
            <div class="main1">
                <h2 class="heading" style="color: rgb(32,85,138);">Welcome to Schools Page</h2>
                <p class="para">Here you can find details of many Schools</p>
                <div class="browse">
                    <input type="text" name="school" class="school" placeholder="Enter the School Name">
  ...
  .tip{
    text-align:center
       ...
       <html>
        ...
        <?php $__currentLoopData = $dataall['fetch']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $school): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>      
        <div class="tips-container">
       <div class="username-coontainer">
           <img src="../assets/images/aboutus.jpg" style="width:50px;height:50px">
           <p style="float: right; margin-right: 66%;margin-top:6%;wrap:normal"><b><?php echo e($school->school_name); ?></b></p>
       </div>
       <div class="tip-name">
       <p>Address:<?php echo e($school->school_address); ?></p>
                     </div>
       <div class="category-container">
           <p>City:<?php echo e($school->city); ?></p>
       </div>
       <div class="desc-container">
                   <p>Country:<?php echo e($school->country); ?></p>
       </div>
       <div class="desc-container">
                   <p>Contact:<?php echo e($school->contact_no); ?></p>
       </div>
   </div>
...
</html><?php /**PATH C:\xampp\xampp\htdocs\laravel\Immigrants_haeven\resources\views/schoolshtml.blade.php ENDPATH**/ ?>