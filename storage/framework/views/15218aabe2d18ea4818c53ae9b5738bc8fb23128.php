...
<div class="sidenav">
    ...
    <div class="heading">
            <h3>Add or Delete or Edit Schools by Country</h3>
     ...
     <tr class="w3-grey">
            ...
            <?php $__currentLoopData = $dataall['fetch']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $school): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <td><?php echo e($school->school_id); ?></td>
                        ...
                        <td><?php echo e($school->contact_no); ?></td>
                        <form method="GET" action="deleteschool">
                            <?php echo csrf_field(); ?>
                        <td><input type="submit" name="delete" class="w3-btn w3-white w3-border w3-round-large" value="Delete" id="delete"></td>
                          <td><a href="manageschools/<?php echo e($school->school_id); ?>">Update</a></td>
                          <td><label class="container">
                            <input type="checkbox" name="checkbox[]" type="checkbox" id="checkbox[]" value= <?php echo e($school->school_id); ?>>
...
</html><?php /**PATH C:\xampp\xampp\htdocs\laravel\Immigrants_haeven\resources\views/manageschools.blade.php ENDPATH**/ ?>