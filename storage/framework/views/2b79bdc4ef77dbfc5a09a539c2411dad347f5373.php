  ...
  .tip{
    text-align:center
       ...
       <img src="../assets/images/aboutus.jpg" style="width:50px;height:50px">
           <p style="float: right; margin-right: 66%;margin-top:6%;wrap:normal"><b><?php echo e($hospital->hospital_name); ?></b></p>
       </div>
       <div class="tip-name">
       <p>Address:<?php echo e($hospital->hospital_address); ?></p>
                     </div>
       <div class="category-container">
           <p>City:<?php echo e($hospital->city); ?></p>
       </div>
       <div class="desc-container">
                   <p>Country:<?php echo e($hospital->country); ?></p>
       </div>
       <div class="desc-container">
                   <p>Contact:<?php echo e($hospital->contact_no); ?></p>
       </div>
   </div>
...
</html><?php /**PATH C:\xampp\xampp\htdocs\laravel\Immigrants_haeven\resources\views/hospitalshtml.blade.php ENDPATH**/ ?>