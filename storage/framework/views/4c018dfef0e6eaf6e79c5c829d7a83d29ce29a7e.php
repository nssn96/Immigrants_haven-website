  ...
  h6,h3{
    display:inline
        ...
        <html>
         <body>
         <?php echo csrf_field(); ?>
         <?php $__currentLoopData = $dataall['fetch']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $contribution): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        
    <div class="tips-container">
        <div class="username-coontainer">
        
        <img src="../assets/images/aboutus.jpg">
            <p style="float: right; margin-right: 66%;margin-top:6%;wrap:normal"><b>PostedBy:<?php echo e($contribution->username); ?></b></p>
        </div>
...
</html><?php /**PATH C:\xampp\xampp\htdocs\laravel\Immigrants_haeven\resources\views/contributionshtml.blade.php ENDPATH**/ ?>