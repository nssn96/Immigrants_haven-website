...
<div class="sidenav">
   ...
   <?php $fetch=$dataall['fetch'];?>
    <form method="GET" action="/edithospital/<?php echo $fetch->hospital_id?>" method="POST">
    <?php echo csrf_field(); ?>
  
    <input type="text" name="name" id="schoolname" value="<?php echo $fetch->hospital_name?>" placeholder="School Name" style="margin-left:40%;margin-top:3%">
    <input type="text" name="address" id="schooladdress" value="<?php echo $fetch->hospital_address?>" placeholder="School Address" style="margin-left:40%;margin-top:3%">
...
</html><?php /**PATH C:\xampp\xampp\htdocs\laravel\Immigrants_haeven\resources\views/hospitalupdate.blade.php ENDPATH**/ ?>